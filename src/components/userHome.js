...
const UserHome = () => {
    return ( 
      ...
      <div className="two">
        ...
        <h3>Explore OverDrive</h3>
        <h4>
          Download comics from Marvel, DC, Fantagraphics, Image, and more via
          Hoopla. Take out each comic for up to 21 days. Explore Hoopla Comics
        </h4>
      </div>
      ...
      <div className="eight">
        ...
        <h4>
          ...
          you’re at the Library. Access the New York Times *In Library access
          only Enjoy complimentary digital access to The Wall Street Journal
          online when you’re at the Main Library.
